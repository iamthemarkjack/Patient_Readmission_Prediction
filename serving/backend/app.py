...
MODEL_INFO_PATH = os.environ.get("MODEL_INFO_PATH", "model_registry_info.json")
META_DATA_PATH = os.environ.get("META_DATA_PATH", "preprocessing_metadata.json")
ENCODERS_PATH = os.environ.get("ENCODERS_PATH", "encoders.pkl")
